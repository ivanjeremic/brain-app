    ...
    i.fn.particle = function (e, a, t) {
      if (
        this.radius = (i.particles.size.random ? Math.random() : 1) *
          ...
          this.x > i.canvas.w - 2 * this.radius ? this.x = this.x - this.radius
      ...
      if ("object" == typeof r) {if (r instanceof Array) {
        ...
        switch (
          ...
          case "bounce":
            a.x + a.radius > i.canvas.w
              ...
              a.y + a.radius > i.canvas.h ? a.vy = -a.vy
